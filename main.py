...
gc = gspread.service_account(filename='credentials_roger_api.json')

key = input("Insert the id of Google sheets (Remember of activated the permission of sharing): ")
print('Opening by key...')
sh = gc.open_by_key(key)

# Key for "Desafio Engenharia de Software Roger Henrique": 1V95MqKRvSNiLpSuPj4WHffYLiWwydDH2-CM2zT42ns0
